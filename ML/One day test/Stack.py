...
def main(argv):
    ...
    if(str(argv[0]) == 'train'):
        print("LGBM")
        l1 = os.system("python /home/alexis/Bureau/Stage/ML/One\ day\ test/LightGBM.py 0.5")
        print("catboost")
        l2 = os.system("python /home/alexis/Bureau/Stage/ML/One\ day\ test/CatBoost.py 0.3")
        print("classic")
        l3 = os.system("python /home/alexis/Bureau/Stage/ML/One\ day\ test/SVC.py 0.17")
        print("NN")
        l4 = os.system("python /home/alexis/Bureau/Stage/ML/One\ day\ test/NeuralNetwork.py 0.3")
        print("XGB")
        l5 = os.system("python /home/alexis/Bureau/Stage/ML/One\ day\ test/XgBoost.py 0.5")
        os.system("python /home/alexis/Bureau/Stage/ML/One\ day\ test/Stack.py")
        return 0
    else:
