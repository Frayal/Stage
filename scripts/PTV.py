...
def load_file(date):
    ...
    Points = pd.read_csv('/home/alexis/Bureau/Project/results/pred/pred_'+str(JOINDATE)+'.csv').values
    proba = pd.read_csv('/home/alexis/Bureau/Project/results/pred/pred_proba_'+str(JOINDATE)+'.csv').values
...
def main(argv):
    if(argv[0] == 'test'):
        ...
        new_PTV.to_html('/home/alexis/Bureau/Project/results/newPTV/PTV/new_PTV-'+date+'.html')
        historyofpoints.to_html('/home/alexis/Bureau/Project/results/newPTV/historyofpts/historyofpoints-'+date+'.html')
        print(date,historyofpoints.shape,len(labels))
        historyofpoints['labels'] = labels
        historyofpoints.to_csv('/home/alexis/Bureau/Project/results/truemerge/true_merge_'+str(date)+'.csv',index=False)
